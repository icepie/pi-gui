...
const EN_US: TranslationTable = {
  ...
  "settings.notifications.system_description": "macOS decides whether 飞度小派 can show desktop notifications at all.",
  "settings.notifications.access": "macOS notification access",
  "settings.notifications.turn_on": "Turn on notifications",
  "settings.notifications.ask_now": "飞度小派 asks macOS when active work first moves into the background. You can also ask now.",
  "settings.notifications.denied_recovery": "macOS notifications are already turned off for 飞度小派. Open System Settings to enable them again.",
  ...
  "settings.notifications.desc.granted": "macOS will allow 飞度小派 to show desktop notifications for background thread updates.",
  "settings.notifications.desc.denied": "macOS notifications are turned off for 飞度小派. Enable them in System Settings to receive background completion alerts.",
  "settings.notifications.desc.default": "飞度小派 has not asked macOS for desktop notification access yet.",
  "settings.notifications.desc.unsupported": "Desktop notifications are unavailable on this system.",
  "settings.notifications.desc.unknown": "Checking whether macOS notifications are available for 飞度小派.",
...
const ZH_CN: TranslationTable = {
  ...
  "settings.notifications.system_description": "是否允许飞度小派显示桌面通知，完全由 macOS 决定。",
  "settings.notifications.access": "macOS 通知权限",
  "settings.notifications.turn_on": "开启通知",
  "settings.notifications.ask_now": "当活动工作首次切到后台时，飞度小派会向 macOS 申请权限。你也可以现在就申请。",
  "settings.notifications.denied_recovery": "macOS 已为飞度小派关闭通知。打开系统设置后可重新启用。",
  ...
  "settings.notifications.desc.granted": "macOS 允许飞度小派为后台线程更新显示桌面通知。",
  "settings.notifications.desc.denied": "macOS 已为飞度小派关闭通知。请到系统设置中重新开启，以接收后台完成提醒。",
  "settings.notifications.desc.default": "飞度小派还没有向 macOS 申请桌面通知权限。",
  "settings.notifications.desc.unsupported": "当前系统不支持桌面通知。",
  "settings.notifications.desc.unknown": "正在检查 macOS 是否允许飞度小派显示通知。",
