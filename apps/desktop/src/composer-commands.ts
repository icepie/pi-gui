...
const HOST_ACTION_SLASH_COMMANDS: readonly ComposerSlashCommand[] = [
  ...
  },
  {
    ...
    command: "/model",
    template: "/model",
    get title() { return t("host_actions.model"); },
    get description() { return t("host_actions.model_description"); },
    submitMode: "pick-option",
    section: "host",
  },
  {
    ...
    command: "/thinking",
    template: "/thinking",
    get title() { return t("host_actions.reasoning"); },
    get description() { return t("host_actions.reasoning_description"); },
    submitMode: "pick-option",
    section: "host",
  },
  {
    ...
    command: "/tree",
    template: "/tree",
    get title() { return t("host_actions.tree"); },
    get description() { return t("host_actions.tree_description"); },
  ...
  },
  {
    ...
    command: "/settings",
    template: "/settings",
    get title() { return t("host_actions.settings"); },
    get description() { return t("host_actions.settings_description"); },
    submitMode: "immediate",
    section: "host",
  },
  {
    ...
    get title() { return t("host_actions.enabled_models"); },
    get description() { return t("host_actions.enabled_models_description"); },
    submitMode: "immediate",
    section: "host",
  },
  {
    ...
    command: "/session",
    template: "/session",
    get title() { return t("host_actions.session"); },
    get description() { return t("host_actions.session_description"); },
    submitMode: "immediate",
    section: "host",
  },
  {
...
export function buildSlashCommandSections(
  ...
  const sections: ComposerSlashCommandSection[] = [
    ...
    {
      id: "host",
      title: hostMatches.length > 0 ? t("host_actions.title") : undefined,
      items: hostMatches,
  },
];
